...
function getReverseGeocodingData(lat, lng) {
  ...
  let month_now_subtract_label = moment(new Date()).subtract(1, 'months').format('MMMM - YYYY')
      ...
      // titikTxtBulan1.innerHTML = "<h3>"+number_filtered_subtract+" <small>Titik</small></h3>";
      // titikTxtBulan2.innerHTML = "<h3>"+number_filtered+" <small>Titik</small></h3>";
      // labelBulan1.innerHTML = "Total Kebakaran Bulan "+month_now_subtract_label;
      // labelBulan2.innerHTML = "Total Kebakaran Bulan "+month_now_label;
